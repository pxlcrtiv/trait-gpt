...
## 2026-09-18 — AI/rarity tip: The rarity curve tells you more than the #1 token
...
## 2026-09-19 — AI/rarity tip: Procedural placeholder art keeps demos legal and offline
...
## 2026-09-20 — AI/rarity tip: Cache images by content hash, not by token id
...
## 2026-09-21 — AI/rarity tip: Zero-shot models need your vocabulary — trait names are not visual attributes
...
## 2026-09-22 — AI/rarity tip: Streamlit caching: cache resources once, cache data by input
...
## 2026-09-23 — AI/rarity tip: pandas 3 changed defaults — write assertions, not assumptions
...
## 2026-09-24 — AI/rarity tip: A rarity API should degrade the same way the demo does
...
## 2026-09-25 — AI/rarity tip: Test the demo path, not just the library
...
## 2026-09-26 — AI/rarity tip: Document the formula in the README and in the code — twice is not enough
